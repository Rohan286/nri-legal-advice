...
<@layout.nlaLayout>
    ...
    <@layout.nlaBreadcrumb activePage="FAQ"></@layout.nlaBreadcrumb>

    <!-- Nav tabs -->
    <section class="container text-center g-pt-120 g-pb-30">
        <h2 class="g-color-primary g-font-weight-600 g-font-size-50 g-mb-70">Frequently Asked Questions</h2>
    <ul class="nav text-center nav-justified u-nav-v7-1" role="tablist" data-target="nav-7-1-default-hor-left-big-icons" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#nav-7-1-default-hor-left-big-icons--1" role="tab">
                <i class="icon-finance-226 u-line-icon-pro   d-block g-font-size-25 u-tab-line-icon-pro"></i>
                PURCHASE
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#nav-7-1-default-hor-left-big-icons--3" role="tab">
                <i class="icon-communication-017 d-block g-font-size-25 u-tab-line-icon-pro"></i>
                UPDATE
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#nav-7-1-default-hor-left-big-icons--4" role="tab">
    ...
    <div id="nav-7-1-default-hor-left-big-icons" class="tab-content g-pt-20">
                        ...
                        <div id="accordion" class="u-accordion u-accordion-color-primary" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-heading-01" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-body-01" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="accordion-body-01">
                                            Guarantee?
                          ...
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-heading-02" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-body-02" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="accordion-body-02">
                          ...
                          <i class="fa fa-angle-up"></i>
                            ...
                            <!-- Card -->
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-heading-03" class="g-brd-bottom g-color-primary--hover g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                          ...
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-heading-04" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-body-04" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="accordion-body-04">
                        ...
                        <div id="accordion-1" class="u-accordion u-accordion-color-primary" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-1-heading-01" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-1-body-01" data-toggle="collapse" data-parent="#accordion-1" aria-expanded="false" aria-controls="accordion-1-body-01">
                                            Guarantee?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-1-heading-02" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-1-body-02" data-toggle="collapse" data-parent="#accordion-1" aria-expanded="false" aria-controls="accordion-1-body-02">
                                            Do you have any built-in caching?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-1-heading-03" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-1-body-03" data-toggle="collapse" data-parent="#accordion-1" aria-expanded="false" aria-controls="accordion-1-body-03">
                                            Can I add/upgrade my plan at any time?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-1-heading-04" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-1-body-04" data-toggle="collapse" data-parent="#accordion-1" aria-expanded="false" aria-controls="accordion-1-body-04">
                                            What access comes with my hosting plan?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
        ...
        <div class="tab-pane fade" id="nav-7-1-default-hor-left-big-icons--3" role="tabpanel">
            <!-- Accordion -->
                        ...
                        <div id="accordion-2" class="u-accordion u-accordion-color-primary" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-2-heading-01" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-2-body-01" data-toggle="collapse" data-parent="#accordion-2" aria-expanded="false" aria-controls="accordion-2-body-01">
                                            Guarantee?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-2-heading-02" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-2-body-02" data-toggle="collapse" data-parent="#accordion-2" aria-expanded="false" aria-controls="accordion-2-body-02">
                                            Do you have any built-in caching?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-2-heading-03" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-2-body-03" data-toggle="collapse" data-parent="#accordion-2" aria-expanded="false" aria-controls="accordion-2-body-03">
                                            Can I add/upgrade my plan at any time?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-2-heading-04" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-2-body-04" data-toggle="collapse" data-parent="#accordion-2" aria-expanded="false" aria-controls="accordion-2-body-04">
                                            What access comes with my hosting plan?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
        ...
        <div class="tab-pane fade" id="nav-7-1-default-hor-left-big-icons--4" role="tabpanel">
            <!-- Accordion -->
                        ...
                        <div id="accordion-3" class="u-accordion u-accordion-color-primary" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-3-heading-01" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-3-body-01" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" aria-controls="accordion-3-body-01">
                                            Guarantee?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-3-heading-02" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-3-body-02" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" aria-controls="accordion-3-body-02">
                                            Do you have any built-in caching?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-3-heading-03" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-3-body-03" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" aria-controls="accordion-3-body-03">
                                            Can I add/upgrade my plan at any time?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
                            ...
                            <div class="card g-brd-none rounded-0 g-mb-20">
                                <div id="accordion-3-heading-04" class="g-brd-bottom g-brd-gray-light-v4 g-pa-0" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed d-flex justify-content-between g-color-main g-color-primary--hover g-text-underline--none--hover rounded-0 g-px-30 g-py-20" href="#accordion-3-body-04" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" aria-controls="accordion-3-body-04">
                                            What access comes with my hosting plan?
                                            <span class="u-accordion__control-icon">
                          <i class="fa fa-angle-down"></i>
                          <i class="fa fa-angle-up"></i>
