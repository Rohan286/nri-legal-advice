<#import "../layouts/layout-no-header.ftl" as layout>
<@layout.nlaLayoutWithoutHeader>
    <!-- Coming Soon -->
    <div class="g-pos-rel g-py-100">
        <div class="g-pos-rel g-z-index-1">
            ...
            <div class="g-max-width-645 text-center mx-auto g-mb-70">
                ...
                <p class="g-font-size-17">We are glad to see you, but please be patient. This page is under construction.</p>
            </div>
            <!-- End Heading -->
            ...
            <div class="container">
                ...
                <div class="g-max-width-550 text-center mx-auto">
                    <div class="mb-4">
                        ...
                        <p class="g-color-gray-dark-v5">Subscribe and stay in touch with the latest news, deals and promotions.</p>
                    </div>

                    <form class="input-group u-shadow-v21">
                        <input class="form-control g-color-gray-dark-v4 g-placeholder-gray-dark-v3 g-brd-gray-light-v4 g-px-25 g-py-17" type="email" placeholder="Enter your email">
                        <span class="input-group-append u-shadow-v19 g-brd-none g-bg-white">
                  <button class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-15" type="submit"><i class="fa fa-long-arrow-right"></i></button>
                </span>
                    </form>
                    <!-- End Subscribe -->
                </div>
