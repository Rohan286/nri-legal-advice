            ...
            <div class="col-auto g-pos-rel">
                <ul class="list-inline g-overflow-hidden g-pt-1 g-mx-minus-4 mb-0">
                    <li class="list-inline-item g-mx-4">
                        ...
                        <ul id="languages-dropdown-2" class="list-unstyled g-pos-abs g-left-0 g-bg-black g-width-160 g-pb-5 g-mt-10 u-dropdown--css-animation u-dropdown--hidden" aria-labelledby="languages-dropdown-invoker-2" style="animation-duration: 300ms; left: 0px;">
                            <li>
